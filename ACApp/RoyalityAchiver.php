...
<head>
	...
	<title>Royality Achiver | Admin Panel</title>
		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col">
							<h5 class="page-title">Royality Achiver</h5>
						</div>
								...
								<div class="card-body">
									...
									<table class="table table-stripped" id="example">
											...
											<tbody>
											    <?php 
											    $cnt=1;
											    $str="Select * from tbl_memberreg where status=1 and team_business>=1000000 order by member_id";
