...
// Statistics Revenue 4
let optionsStatisticsRevenue4 = {
    series: [
        {
            data: [0, 20, 10, 40, 50, 30],
        },
...
if (document.querySelector("#statistics-revenue-4")) {
    let chart = new ApexCharts(document.querySelector("#statistics-revenue-4"), optionsStatisticsRevenue4);
    chart.render();
}


// Statistics Revenue 5 
let optionsStatisticsRevenue5 = {
    series: [
        {
            data: [0, 20, 10, 40, 50, 30],
        },
...
if (document.querySelector("#statistics-revenue-5")) {
    let chart = new ApexCharts(document.querySelector("#statistics-revenue-5"), optionsStatisticsRevenue5);
    chart.render();
}



// Statistics Revenue 6
let optionsStatisticsRevenue6 = {
    series: [
        {
            data: [0, 20, 10, 40, 50, 30],
        },
...
if (document.querySelector("#statistics-revenue-6")) {
    let chart = new ApexCharts(document.querySelector("#statistics-revenue-6"), optionsStatisticsRevenue6);
    chart.render();
}
