...
<head>
	...
	<title>Auto Tripod Order | Admin Panel</title>
		...
		<div class="page-wrapper">
			...
			<?php $matrix=$_REQUEST['Tripod']; ?>
				...
				<div class="page-header">
					<div class="row">
						<div class="col">
							<h5 class="page-title">Auto Tripod Order List <?php echo $matrix; ?> $</h5>
						</div>
									...
									<div class="table-responsive">
										<table class="datatable table table-stripped">
											...
											<tbody>
											    <?php 
											    $cnt=1;
											    $str="Select * from tbl_autopool where current_pool=$matrix and total_member<3 order by smart_id";
