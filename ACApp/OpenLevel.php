...
<head>
	...
	<title>Open Level | Admin Panel</title>
									...
									<table class="table table-stripped" id="example">
											<thead>
												<tr style="background-color: #ff0080;color:#FFF">
                                                	...
                                                	<th>Dualified Direct </th>
												</tr>
											</thead>
											<tbody>
											    <?php 
											    $cnt=1;
											    $str="Select * from tbl_memberreg where status=1 and  	qulifid_direct>=3 and direct_business>=1000 order by member_id";
										...
										<div class="dropdown-menu">
											<a class="dropdown-item" href="../../AuraUApp/DashLogin?Uid=<?php echo $row['member_user_id']; ?>" target="_blank">Dashboard</a>
													...
													<td><?php echo $row['qulifid_direct']; ?></td>
