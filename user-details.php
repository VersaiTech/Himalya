                ...
                <div class="hp-sidebar-header-menu">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        <ul>
                          <li>
                            <a href="mt5.php" class="submenu-item">
                              <span>
                                <span class="submenu-item-icon">
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                        ...
                        <ul>
                          <li>
                            ...
                            <ul class="submenu-children" data-level="1">
                              <li>
                                <a href="see-live-account.php">
                                  <span>See Live Account</span>
                                </a>
                              </li>
                              <li>
                                <a href="live-reset-password.php">
                                  <span>Reset Password</span>
                                </a>
                              </li>
        
                              <li>
                                <a href="live-account-details.php">
                          ...
                          <li>
                            ...
                            <ul class="submenu-children" data-level="1">
                              <li>
                                <a href="see-demo-account.html">
                                  <span>See Demo Account</span>
                                </a>
                              </li>
                              <li>
                                <a href="demo-reset-password.html">
                                  <span>Reset Password</span>
                                </a>
                              </li>
        
                              <li>
                                <a href="demo-account-details.html">
                          ...
                          <li>
                            <a href="investor-reset-password.html">
                              <div
                                class="tooltip-item in-active"
                                data-bs-toggle="tooltip"
                                data-bs-placement="right"
                      ...
                      <li>
                        ...
                        <ul>
                          <li>
                            ...
                            <ul class="submenu-children" data-level="1">
                              <li>
                                <a href="deposit-by-usdt.html">
                                  <span>Deposit By USDT</span>
                                </a>
                              </li>
        
                              <li>
                                <a href="deposit-history.html">
                          ...
                          <li>
                            <a href="/wallet-finance.html" class="submenu-item">
                              <span>
                                <span class="submenu-item-icon">
                                  <svg
                                    xmlns="http://www.w3.org/2000/svg"
                       ...
                       <li>
                          <a href="customer-support.html" class="menu-link">
        ...
        <div class="hp-main-layout">
                    ...
                    <div class="col px-0 mb-15">
                        <div class="row w-100 align-items-center justify-content-between position-relative">
                            ...
                            <div class="hp-header-text-info col col-lg-14 col-xl-16 hp-header-start-text d-flex align-items-center hp-horizontal-none">
                                ...
                                <p class="hp-header-start-text-item hp-input-label fw-normal hp-text-color-black-100 hp-text-color-dark-0 ms-12 mb-0 lh-1 d-flex align-items-center" style="font-size: 1.1rem;">
                                            ...
                                            <div class="p-24 rounded hp-bg-black-0 hp-bg-dark-100">
                                                ...
                                                <div class="hp-overflow-y-auto px-10" style="max-height: 400px; margin-right: -10px; margin-left: -10px;">
                                                    ...
                                                    <div class="row hp-cursor-pointer rounded hp-transition hp-hover-bg-primary-4 hp-hover-bg-dark-80 py-12 px-10" style="margin-left: -10px; margin-right: -10px;">
                                                        ...
                                                        <div class="w-auto px-0 col">
                                                            <p class="d-block fw-medium hp-p1-body hp-text-color-black-100 hp-text-color-dark-0 mb-4">
                                                                User Adams <span class="hp-text-color-black-60">invite you</span> to Prototyping
                                                            </p>
            ...
            <div class="row mb-32 gy-32">
                                ...
                                <div class="row">
                                    <div class="col-12 mb-15">
                                        <div class="row align-items-start justify-content-between">
                                            <div class="col">
                                                <h3 class="mb-9">Account Details </h3>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row align-items-center justify-content-between mt-12">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="hp-p1-body mb-0" style="font-size: 1.1rem;">Full Name</p>
                                                </div>
                                            </div>

                                            <div class="col-6">
                                                <div class="d-flex align-items-center justify-content-end position-relative">
                                                    <p class="hp-badge-text mb-0 me-8" style="font-size: 1.1rem;" >50.2%</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row align-items-center justify-content-between mt-12">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="hp-p1-body mb-0" style="font-size: 1.1rem;">Username</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row align-items-center justify-content-between mt-12">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="hp-p1-body mb-0" style="font-size: 1.1rem;">Documents Approve</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row align-items-center justify-content-between mt-12">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="hp-p1-body mb-0" style="font-size: 1.1rem;">Email</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row align-items-center justify-content-between mt-12">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="hp-p1-body mb-0" style="font-size: 1.1rem;">Mobile No.</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row align-items-center justify-content-between mt-12">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="hp-p1-body mb-0" style="font-size: 1.1rem;">Address</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row align-items-center justify-content-between mt-12">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="hp-p1-body mb-0" style="font-size: 1.1rem;">Reg. Date</p>
                                                </div>
                                            </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="card custom-card" style="min-height: 35vh;">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 mb-15">
                                        <div class="row align-items-start justify-content-between">
                                            <div class="col">
                                                <h3 class="mb-9">User Bank Details </h3>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row align-items-center justify-content-between mt-12">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="hp-p1-body mb-0" style="font-size: 1.1rem;">Account Holder's Name</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row align-items-center justify-content-between mt-12">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="hp-p1-body mb-0" style="font-size: 1.1rem;">Bank Name</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row align-items-center justify-content-between mt-12">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="hp-p1-body mb-0" style="font-size: 1.1rem;">IFSC Code</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row align-items-center justify-content-between mt-12">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="hp-p1-body mb-0" style="font-size: 1.1rem;">Account Number</p>
                                                </div>
                                            </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 mb-15">
                                        <div class="row align-items-start justify-content-between">
                                            <div class="col">
                                                <h3 class="mb-9">Mt4 Account Details</h3>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row align-items-center justify-content-between mt-12">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="hp-p1-body mb-0" style="font-size: 1.1rem;">Live Account Limit</p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row align-items-center justify-content-between mt-12">
                                            <div class="col-6">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <p class="hp-p1-body mb-0" style="font-size: 1.1rem;">Demo Account Limit</p>
                                                </div>
                                            </div>
            ...
            <footer class="w-100 py-18 px-16 py-sm-24 px-sm-32 hp-bg-color-black-20 hp-bg-color-dark-90">
                <div class="row">
                    <div class="col-12">
                        <p class="hp-badge-text fw-semibold mb-0 text-center text-sm-start hp-text-color-dark-30">COPYRIGHT ©2024 Orion Trade Ai, All rights Reserved</p>
                    </div>
                </div>
            </footer>
        ...
        <div class="hp-theme-customizer-container bg-black-0 hp-bg-dark-90">
            <div class="hp-theme-customizer-container-header bg-black-10 hp-bg-dark-85 py-16 px-24">
                <div class="d-flex justify-content-between">
                    <div>
                        <span class="h5 mb-0 d-block text-black-80 hp-text-color-dark-0">Customise your Orion</span>
                        <span class="hp-caption fw-medium d-block text-black-60">Orion Trade Ai</span>
                    </div>
