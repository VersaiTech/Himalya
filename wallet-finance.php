...
<html dir="ltr">
  <head>
    ...
    <!-- Favicon -->
    <?php
    include "components/cssComponents/wallet-finance-css.php"
    ?>
            ...
            <ul>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="/pool-withdrawal.html" class="submenu-item">
                                <span>
                                    <span class="submenu-item-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewbox="0 0 24 24" fill="none">
                                            <path d="M4.26 11.02v4.97c0 1.82 0 1.82 1.72 2.98l4.73 2.73c.71.41 1.87.41 2.58 0l4.73-2.73c1.72-1.16 1.72-1.16 1.72-2.98v-4.97c0-1.82 0-1.82-1.72-2.98l-4.73-2.73c-.71-.41-1.87-.41-2.58 0L5.98 8.04C4.26 9.2 4.26 9.2 4.26 11.02Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                ...
                <div class="card-body">
                    <div class="row justify-content-between">
                        ...
                        <div class="col-12 mt-24 hljs-container">
                            <pre>
                <code class="html" data-component='table' data-code='hoverable-rows'></code>
            </pre>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row justify-content-between">
                            <div class="col pe-md-32 pe-md-120">
                                <h4>Wallet Finance</h4>
                            </div>

                            <div class="row mt-24">
                              <div class="col-6">
                                  <label for="datepicker1" class="form-label">From:</label>
                                  <input type="text" id="datepicker1" class="form-control" autocomplete="off">
                              </div>
                              <div class="col-6">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>765046</td>
                                            <td>CRM Wallet</td>
                                            <td>30 to Transfer CRM Wallet</td>
                                            <td>None</td>
                                            <td>USD</td>
                                            <td>Success</td>
                                        </tr>
  ...
  ?>
    ...
    <!-- Plugin -->
    <?php
    include "components/jsComponents/wallet-finance-js.php"
    ?>
  </body>
</html>
