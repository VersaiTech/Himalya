...
<body>
                            ...
                            <div class="col hp-profile-menu py-24" style="flex: 0 0 240px;">
                                ...
                                <div class="hp-profile-menu-body w-100 text-start mt-48 mt-lg-0">
                                    <ul class="me-n1 mx-lg-n12">
                                        ...
                                        <li class="mt-4 mb-16">
                                            <a href="profile-activity" class="active position-relative text-black-80 hp-text-color-dark-30 hp-hover-text-color-primary-1 hp-hover-text-color-dark-0 py-12 px-24 d-flex align-items-center">
                            ...
                            <div class="col ps-16 ps-sm-32 py-24 py-sm-32 overflow-hidden">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p class="hp-p1-body mb-0">Ensure your address is accurate for timely communications. Visit your account settings to update your address information.
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body py-48">
                            <form>
                                <div class="row g-24">
                                    <div class="col-12">
                                        <label for="fullName" class="form-label">House/Plat No. </label>
                                        <input type="text" class="form-control" id="fullName">
                                    </div>
                                    <div class="col-12">
                                        <label for="fullName" class="form-label">Road Name / Area</label>
                                        <input type="text" class="form-control" id="fullName">
                                    </div>

                                    <div class="col-12">
                                        <label for="displayName" class="form-label">Land Mark</label>
    ...
    <?php
    include "components/jsComponents/profile-activity-js.php";
    ?>
</body>
