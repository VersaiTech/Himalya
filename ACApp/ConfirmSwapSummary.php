...
<head>
	...
	<title>Confirm Swap Summary | Admin Panel</title>
		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col">
							<h5 class="page-title">Swap Summary </h5>
						</div>
								...
								<div class="card-body">
									...
									<table class="table table-stripped" id="example">
											...
											<tbody>
											    <?php 
											    $cnt=1;
											    $str="Select * from Deposit where paid_status=1 order by id desc";
											    $res=mysqli_query($connection,$str);
											    while($row=mysqli_fetch_array($res))
											    {
											         $total=$total+$row['amount']/1e9;
											    ?>
												<tr>
										...
										<td><?php echo date("d-M-Y H:i:s",$row['block_timestamp']); ?></td>
											<td><?php echo $row['investor']; ?></td>
													...
													<td><?php if($row['paid_status']==0){ echo "Pending"; }else {?><a href="https://gaurascan.com/tx/<?php echo $row['pay_transaction_id']; ?>" class="btn btn-warning" target="_blank">Orion Transation </a> <?php } ?></td>
