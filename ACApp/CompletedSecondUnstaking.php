		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col">
							<h5 class="page-title">Completed Second Unstaking(30%)</h5>
						</div>
									...
									<div class="table-responsive">
										<table class="table table-stripped" id="example">
											...
											<tbody>
											   ...
											   $str="Select * from tbl_reinvest where second_date<'$first_date'  order by record_no asc";
                                        ...
                                        <tr>
                                            ...
                                            <td><b><?php echo $busdStaking; ?></b></td>
                                             <td><b><?php echo $auraStaking; ?></b></td><td></td>
                                        </tr>
