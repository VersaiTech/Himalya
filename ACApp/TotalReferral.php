...
include "Admintreecalculation.php";
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row">
                        <div class="col">
                            <h5 class="page-title">Referral Summary</h5>
                        </div>
                    </div>
                </div>
                                    ...
                                    <table class="table table-stripped" id="example">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_array($res)) {
                                                ...
                                                $investmentResult = getInvestments($userid);
                                            ?>
                                                <tr>
                                                    <td>
                                                        <div class="btn-group">
                                                    ...
                                                    <td><?php echo $investmentResult['leftTreeInvestment'] ?></td>
                                                    <td><?php echo $investmentResult['rightTreeInvestment'] ?></td>
                                                </tr>
                                            <?php 
                                            } 
                                            ?>
