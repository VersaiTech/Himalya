                ...
                <div class="hp-logo-item m-16 m-sm-32 m-md-64 w-auto px-0 col-12">
                    <div class="hp-header-logo d-flex align-items-center">
                        <a href="overview" class="position-relative">
                            ...
                            <img class="hp-logo hp-sidebar-visible hp-dark-none" src="app-assets/img/logo/logo-small.png" alt="logo">
            ...
            <div class="row align-items-center justify-content-center h-100 mx-4 mx-sm-n32">
                <div class="col-12 col-md-9 col-xl-7 col-xxxl-5 px-8 px-sm-0 pt-24 pb-48">
                    ...
                    <form class="mt-16 mt-sm-32 mb-8">
                        <div class="mb-16">
                            <label for="loginUsername" class="form-label">Email Address : 
                                <span style="color: red;">*</span>
                            </label>
                            <input type="text" class="form-control" id="loginEmail" placeholder="Enter Email Address">
                        </div>
                        ...
                        <div class="row align-items-center justify-content-between mb-16">
                            ...
                            <div class="col hp-flex-none w-auto">
                                <a class="hp-button text-black-80 hp-text-color-dark-40" href="auth-recover">Forgot Password?</a>
                            </div>
                        </div>

                        <button class="btn btn-primary w-100" onclick="Login(); return false;">
                    ...
                    <div class="col-12 hp-form-info text-center">
                        ...
                        <a class="text-primary-1 hp-text-color-dark-primary-2 hp-caption" href="auth-register-metamask-1.php?UplineId=3764219&RandomId=0xd203a917">Create an account</a>
                    </div>
    ...
    <script>
        ...
        async function Login() {
            ...
            try {
                ...
                var dataStringr = 'email_id=' + email + '&password=' + password;
