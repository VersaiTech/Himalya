            ...
            <div class="row align-items-center justify-content-center h-100 mx-4 mx-sm-n32">
                <div class="col-12 col-md-9 col-xl-7 col-xxxl-5 px-8 px-sm-0 pt-24 pb-48">
                    ...
                    <div class="mt-16 mt-sm-32 mb-8">
                        ...
                        <button onclick="submitForm()" class="btn btn-primary w-100">
                            Reset Password
                        </button>
                    </div>
                    ...
                    <script>
                        function submitForm() {
                            ...
                            var email_id = urlParams.get('email_id');
                            ...
                            $.ajax({
                                ...
                                success: function (response) {
                                    ...
                                    else if(response === "Invalid OTP or OTP has expired.")
                                    Swal.fire({
                                        icon: 'error',
                                        title: 'Error !',
                                        text: "Invalid OTP or OTP has expired. Please Try Again",
                                        // showConfirmButton: true
                                    })
                                    else
                                    Swal.fire({
