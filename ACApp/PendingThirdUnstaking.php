...
<head>
	...
	<title>Unstaking Summary | Admin Panel</title>
		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col">
							<h5 class="page-title">Pending Third Unstaking(100%)</h5>
						</div>
									...
									<div class="table-responsive">
										<table class="table table-stripped" id="example">
											...
											<tbody>
											   ...
											   $str="Select * from tbl_reinvest where second_date>='$first_date' and  	third_date<='$first_date'  order by record_no asc";
										...
										<td><?php echo date("d-M-Y",strtotime($row['tr_date'])); ?></td>
											<td><?php echo date("d-M-Y",strtotime($row['third_date'])); ?></td>
