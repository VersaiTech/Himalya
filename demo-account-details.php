...
<head>
    ...
    <?php
    include "components/cssComponents/demo3-css.php";
    ?>
...
<body>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
                                    <h3 class="card-title mb-15">Demo Account Details</h3>
    ...
    <?php
    include "components/jsComponents/demo3-js.php";
    ?>
