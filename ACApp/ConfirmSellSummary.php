...
<head>
	...
	<title>Sell Summary | Admin Panel</title>
		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col">
							<h5 class="page-title">Sell Summary </h5>
						</div>
							...
							<div class="card">
								...
								<div class="card-body">
									...
									<table class="table table-stripped" id="example">
											...
											<tbody>
											    <?php 
											    $cnt=1;$tokenQty=0;$aanaQty=0;
											    $str="Select * from TokenSell  order by id desc";
											    $res=mysqli_query($connection,$str);
											    while($row=mysqli_fetch_array($res))
											    {
											        $tokenQty=$tokenQty+$row['tokenQty'];
											        $aanaQty=$aanaQty+$row['aanaQty'];
											    ?>
												<tr>
										...
										<td><?php echo date("d-M-Y H:i:s",$row['block_timestamp']); ?></td>
											<td><?php echo $row['user']; ?></td>
													...
													<td><a href="https://gaurascan.com/tx/<?php echo $row['transaction_id']; ?>" class="btn btn-warning" target="_blank">Transaction </a></td>
