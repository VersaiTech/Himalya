...
<body>
  <main class="hp-bg-color-dark-90 d-flex min-vh-100">
    ...
    <div class="hp-main-layout">
      ...
      if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        echo "The name of group is " . $mt5group . " and the value of leverage is " . $leverage;
        ...
        // Check if connection got established or not 
        if (!$conn) {
          die("Sorry we failed to connect to the db " . mysqli_connect_error());
        } else {
          echo "Connection Successful";
          $sql = "INSERT INTO `contact` (`mt5group`, `leverage`) VALUES ('$mt5group', '$leverage')";
          $result = mysqli_query($conn, $sql);

          // Lets See if data added
          if ($result) {
            echo "Data added";
          } else {
            echo "Data didnt' added";
          }
        }
      }
      ?>
      ...
      <div class="hp-main-layout-content">
        <div class="row mb-32 gy-32">
          ...
          <div class="col-12 col-md-8">
            <div class="card custom-card">
              <div class="card-body">
                <h3 class="card-title mb-32">Live Account</h3>
                <form action="see-live-account.php" method="post">
                  <div class="mb-24 mt-15">
                    <label for="mt5group" class="form-label">MT5 Group</label>
                    <!-- <select class="form-select" id="mt5group" aria-describedby="mt5groupHelp">
                                            <option value="" selected>Please Select</option>
                                            <option value="Orion//Demo">Orion//Live</option>
                                        </select> -->
                    <input type="text" name="mt5group" value="" class="form-control">
                  </div>
                  <div class="mb-24">
                    <label for="leverage" class="form-label">Choose Leverage</label>
                    ...
                    <input type="text" name="leverage" value="" class="form-control">
                  </div>
                  ...
                  <div class="d-flex justify-content-end">
                    <button class="pushable">
                      ...
                      <span class="front">Open Live Account</span>
                    </button>
                  </div>
                </form>
              </div>
          ...
          <div class="col-12 col-md-4">
            <div class="card hp-card-5" style="margin-top: 14px;">
              <div class="card-body">
                <h5 class="mb-32">How To Open Live Account.</h5>

                <ul class="timeline hp-p2-body">
                  <li class="timeline-item">
                    <div class="timeline-item-tail"></div>
                    <div class="timeline-item-head"></div>
                    <div class="timeline-item-content">Select mt5 GROUP Dropdown</div>
                  </li>
                  <li class="timeline-item">
                    <div class="timeline-item-tail"></div>
                    <div class="timeline-item-head"></div>
                    <div class="timeline-item-content">Select Choose Leverage Dropdown</div>
                  </li>
                  <li class="timeline-item">
                    <div class="timeline-item-tail"></div>
                    <div class="timeline-item-head"></div>
                    <div class="timeline-item-content">Click On Open Live Account Button</div>
                  </li>
                  <li class="timeline-item">
                    <div class="timeline-item-tail"></div>
                    <div class="timeline-item-head"></div>
                    <div class="timeline-item-content">Finish</div>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <!-- Lower Details -->
        <div class="row mb-32 ml-5 gy-32">
          <!-- custom form -->
          <div class="col-12 col-md-8">
            <div class="card hp-card-3 hp-eCommerceCardOne" style="margin-left: 1.1vw;">
              <div class="card-body">
                <div class="row">
                    ...
                    <div class="row align-items-center justify-content-between mt-12">
                      <div class="col-6">
                        <div class="d-flex align-items-center">
                          ...
                          <p class="hp-p1-body mb-0" style="font-size: 1rem;">Live ID</p>
                        </div>
                      </div>

                      <div class="col-6">
                        <div class="d-flex align-items-center justify-content-end position-relative">
                          <p class="hp-badge-text mb-0 me-8" style="font-size: 1rem;">50.2%</p>
                        </div>
                      </div>
                    </div>
                    <div class="row align-items-center justify-content-between mt-12">
                      <div class="col-6">
                        <div class="d-flex align-items-center">
                          ...
                          <p class="hp-p1-body mb-0" style="font-size: 1rem;">Password</p>
                        </div>
                      </div>
                    ...
                    <div class="row align-items-center justify-content-between mt-12">
                      <div class="col-6">
                        <div class="d-flex align-items-center">
                          ...
                          <p class="hp-p1-body mb-0" style="font-size: 1rem;">Leverage</p>
                        </div>
                      </div>
                    ...
                    <div class="row align-items-center justify-content-between mt-12">
                      <div class="col-6">
                        <div class="d-flex align-items-center">
                          ...
                          <p class="hp-p1-body mb-0" style="font-size: 1rem;">Server Name Live</p>
                        </div>
                      </div>
  ...
  <?php
  include "components/jsComponents/live1-js.php";
  ?>
