  ...
  <main class="hp-bg-color-dark-90 d-flex min-vh-100">
    ...
    <div class="hp-main-layout">
      ...
      <div class="hp-main-layout-content">
        <div class="row mb-32 gy-16">

        <div class="col-12">
            <div class="row align-items-center justify-content-between g-24 mt-80">
              <div class="col-12 col-md-6">
                <h3>Your Payout Method</h3>
                ...
                <div class="row g-32 mt-20">
                  ...
                  Before we can pay you, we must have your Payment Information. Be sure that are properly submitted.
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div class="mb-4 col-12">
                      <div class="row align-items-center justify-content-between">
                        <div class="flex-shrink-1 col">
                          <p class="hp-p1-body mb-0 hp-text-color-black-100 hp-text-color-dark-0">Bank Account details</p>
                          <h4 class="mb-8 fw-bold" id="referralLink" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 100%;">
                          You can receive earnings in personal bank account</h4>

                           <!-- Textarea with padding and spacing -->
                  <textarea class="form-control mt-3" rows="4" placeholder="Enter your bank details here..." 
                            style="padding: 12px; border-radius: 8px; border: 1px solid #ced4da; width: 100%; box-shadow: 0 2px 6px rgba(0, 0, 0, 0.1);">
                  </textarea>
                        </div>
                      </div>
                    </div>
