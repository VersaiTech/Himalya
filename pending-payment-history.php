                        ...
                        <div class="card custom-card p-0 m-0">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center flex-wrap mb-3">
                                    <h3 class="card-title mb-15">Pending Payments</h3>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover">
                                        <thead>
                                            ...
                                            <th scope="col" style="min-width: 150px;">UTR NUMBER</th>
                                            <th scope="col" style="min-width: 170px;">AMOUNT</th>
                                            <th scope="col" style="min-width: 120px;">STATUS</th>
                                        </thead>
                                        <tbody id="tableBody">
                                        <button class="btn btn-secondary me-2 mb-2 mb-md-0 btn-sm" onclick="window.location.href='payment-history'">>
                                        <span class="bi bi-payment"></span>&nbsp;&nbsp;Show Successful Payments</button>
                                            ...
                                            <?php else: ?>
                                                <tr>
                                                    <td colspan="6">No pending payments found for this user.</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
