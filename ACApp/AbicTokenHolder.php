...
<head>
	...
	<title>Token Holder | Admin Panel</title>
		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col">
							<h5 class="page-title">Token Holder List</h5>
						</div>
									...
									<div class="table-responsive">
										<table class="datatable table table-stripped">
											...
											<tbody>
											    <?php 
											    $cnt=1;
											    $str="Select * from tbl_memberreg where status=1 and abic_token_wallet>0 order by member_id";
												...
												<tr>
													...
													<td><?php echo $row['abic_token_wallet']; ?></td>
