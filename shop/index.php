...
if ($is_logged_in && !empty($member_user_id)) {
    // Check if mobile_number is already in the session
    if (!isset($_SESSION['mobile_number'])) {
        // Prepare the SQL query to fetch mobile_number from tbl_memberreg
        $stmt = $connection->prepare("SELECT mobile_number FROM tbl_memberreg WHERE member_user_id = ?");
        $stmt->bind_param("s", $member_user_id); // Use "i" if member_user_id is an integer
        $stmt->execute();
        $stmt->bind_result($mobile_number);
        $stmt->fetch();

        // Store mobile_number in session if found
        if (!empty($mobile_number)) {
            $_SESSION['mobile_number'] = $mobile_number;
        } else {
            echo "No mobile number found for the given member_user_id.";
        }
...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="description" content="Himallya RO Service: A sleek, responsive, and user-friendly HTML template designed for online grocery stores.">
                    ...
                    <div class="col-lg-12">
                        <div class="logo-search-category-wrapper">
                            ...
                            <div class="accont-wishlist-cart-area-header">
                                <a href="http://localhost/Himallya-MLM-1/overview" class="btn-border-only account">
                                ...
                                ?>
                                    <div class="btn-border-only wishlist category-hover-header">
                                        ...
                                        <div class="category-sub-menu card-number-show d-flex align-items-center">
                                            ...
                                            <a href="http://localhost/Himallya-MLM-1/login" class="rts-btn btn-primary border-only">Login</a>
                                        </div>
                                    </div>
                                        ...
                                        <div class="category-sub-menu card-number-show">
                                            ...
                                            <div class="sub-total-cart-balance">
                                                ...
                                                <div class="button-wrapper d-flex align-items-center justify-content-center">
                                                    <a href="http://localhost/Himallya-MLM-1/auth-register-metamask-1.php?UplineId=3764219&RandomId=0xd203a917" class="rts-btn btn-primary border-only">Join Now</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="button-area-main-wrapper-menuy-sidebar mt--50">
            ...
            if (isset($_SESSION['member_user_id']) && isset($_SESSION['email_id'])) {
              ...
              style="width: 100%; text-align: center; padding: 10px; border: 1px solid #ccc; background-color: #f7f7f7; min-width: 9vw;">';
                ...
                echo '<a href="http://localhost/Himallya-MLM-1/overview" class="rts-btn btn-primary mobile-btn mt-10">My Account</a>';
            } else {
                // User is not logged in, show the "Login" and "Join" buttons
            ?>
                <div class="button-area-bottom">
                    <a href="http://localhost/Himallya-MLM-1/login" class="rts-btn btn-primary mobile-btn mb-10">Affiliate Login</a>
                    <a href="http://localhost/Himallya-MLM-1/auth-register-metamask-1.php?UplineId=3764219&RandomId=0xd203a917" class="rts-btn btn-primary border-only mt-10">Join</a>
                </div>
            <?php
            }
            ?>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="feature-product-area-single bg_image">
                        ...
                        <div class="inner-content" style="text-align: center;">
                            ...
                            <a href="http://localhost/Himallya-MLM-1/login" class="affiliate-login-btn" style="display: inline-block; margin-top: 15px; text-align: center; background-color: #007bff; color: #fff; padding: 8px 20px; border-radius: 5px; font-size: 14px;">
                                Login
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="feature-product-area-single two bg_image">
                        ...
                        <div class="inner-content" style="text-align: center;">
                            ...
                            <a href="http://localhost/Himallya-MLM-1/auth-register-metamask-1.php?UplineId=3764219&RandomId=0xd203a917" class="join-affiliate-btn" style="display: inline-block; margin-top: 15px; text-align: center; background-color: #28a745; color: #fff; padding: 8px 20px; border-radius: 5px; font-size: 14px;">
                                Join Now
                            </a>
                        </div>
                    </div>
            ...
            fetch('process_utr', {
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        window.location.href = 'http://localhost/Himallya-MLM-1/pending-payment-history';
                    } else {
