...
">
    ...
    $status = $row['status'];
    if ($status === 'pending') {
        echo '<span class="mybadge ">Pending</span>';
    } elseif ($status === 'success') {
        echo '<span class="mybadge ">Success</span>';
    } else {
        echo '<span class="mybadge bg-secondary">Unknown</span>'; // For any other status or default case
    }
    ?></td>
												</tr>
