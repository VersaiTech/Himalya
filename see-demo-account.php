...
<head>
  ...
  <?php
          include "components/cssComponents/demo1-css.php";
          ?>
...
<body>
        ...
        <div class="row mb-32 gy-32">
          ...
          <div class="col-12 col-md-8">
            <div class="card custom-card">
              <div class="card-body">
                <h3 class="card-title mb-32">Demo Account</h3>
                <form>
                  <div class="mb-24 mt-15">
                    ...
                    <select class="form-select" id="mt5group" aria-describedby="mt5groupHelp">
                      ...
                      <option value="Orion//Demo">Orion//Demo</option>
                    </select>
                  </div>
                  <div class="mb-24">
                  ...
                  <div class="d-flex justify-content-end">
                    <button class="pushable">
                      ...
                      <span class="front">Open Demo Account</span>
                    </button>
                  </div>
                </form>
              </div>
          ...
          <div class="col-12 col-md-4">
            <div class="card hp-card-5" style="margin-top: 14px;">
              <div class="card-body">
                <h5 class="mb-32">How To Open Demo Account.</h5>
                ...
                <ul class="timeline hp-p2-body">
                  ...
                  <li class="timeline-item">
                    <div class="timeline-item-tail"></div>
                    <div class="timeline-item-head"></div>
                    <div class="timeline-item-content">Click On Open Demo Account Button</div>
                  </li>
                  <li class="timeline-item">
                    <div class="timeline-item-tail"></div>
                    <div class="timeline-item-head"></div>
  ...
  <?php
          include "components/jsComponents/demo1-js.php";
          ?>
