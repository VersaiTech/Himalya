		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col">
							<h5 class="page-title">Pending Second Unstaking(30%)</h5>
						</div>
									...
									<div class="table-responsive">
										<table class="table table-stripped" id="example">
											...
											<tbody>
											   ...
											   $str="Select * from tbl_reinvest where first_date>='$first_date' and second_date<='$first_date'  order by record_no asc";
