        ...
        <div class="col-12 col-lg-6 py-sm-64 py-lg-0">
            <div class="row align-items-center justify-content-center h-100 mx-4 mx-sm-n32">
                <div class="col-12 col-md-9 col-xl-7 col-xxxl-5 px-8 px-sm-0 pt-24 pb-48">
                    ...
                    <p class="mt-sm-8 mt-sm-0 text-black-60">We'll send password reset instructions to your email</p>

                    <!-- <form class="mt-16 mt-sm-32 mb-8" action="reset-passwordcopy" method="POST">
                        <div class="mb-24">
                        ...
                        <button type="submit" class="btn btn-primary w-100">
                            <a href="reset-passwordcopy" class="d-block w-100" style="color: inherit;">Reset Password</a>
                        </button>
                    </form> -->
                    ...
                    <div class="mt-16 mt-sm-32 mb-8">
                        ...
                        <button id="submitButton" onclick="submitForm()"="btn btn-primary w-100">
                            Reset Password
                        </button>
                    </div>
                    ...
                    <script>
                        function submitForm() {
                            ...
                            $.ajax({
                                url: 'forget-password',
                                type: 'POST',
                                data: { recoverEmail: email },
                                success: function (response) {
                                    // console.log(response);
                                    // Handle success response
                                    // alert('Password reset instructions have been sent to your email.');
                                    // window.location.href = 'reset-passwordcopy?email_id=' + email;

                                    if (response === 'OTP sent successfully! Check your email.') {
                                        Swal.fire({
                                            icon: 'success',
                                ...
                                error: function (xhr, status, error) {
                                    ...
                                    if (error === "Error: Email address not found.") {
                                        Swal.fire({
                                            title: 'Error!',
                                            text: "Email address not found.",
                                            icon: 'error',
