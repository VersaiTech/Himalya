		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col">
							<h5 class="page-title">Block User List</h5>
						</div>
								...
								<div class="card-body">
									...
									<table class="table table-stripped" id="example">
											...
											<tbody>
											    <?php 
											    $cnt=1;
											    $str="Select * from tbl_memberreg where status=0 or isblock=1 order by member_id";
												...
												<tr>
												    ...
												    <td><?php echo $cnt++; ?></td>
												    <td><a class="btn btn-success" href="Apk/UnblockUser?Uid=<?php echo $row['member_user_id']; ?>" onClick="return confirm('Sure to Want Unblock This User');">UnBlock</a></td>
