            ...
            <div class="content container-fluid">
                ...
                <div class="page-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h5 class="page-title">Denied Withdrawal Requests</h5>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped" id="example">
                                        ...
                                        <tbody>
                                            <?php
                                          // Fetch only denied requests
											$str = "SELECT * FROM withdrawal_requests WHERE status = 'deny' ORDER BY request_date DESC";
