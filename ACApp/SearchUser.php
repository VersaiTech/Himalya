						...
						<div class="card-body pb-0">
							<div class="row filter-row">
								...
								<div class="col-sm-6 col-md-3">
									...
									<div class="col-sm-6 col-md-3">
									<div class="form-group">
										<a class="btn btn-primary btn-block" href="../../AuraUApp/DashLogin?Uid=<?php echo $row['member_user_id']; ?>" target="_blank" style="padding-top:10px">Dashboard</a>
									</div>
								</div>
									...
									<div class="form-group">
									    <?php if($isblock==0) { ?>
										<a class="btn btn-warning btn-block" href="Apk/BlockUser?user=<?php echo $row['member_user_id']; ?>" style="padding-top:10px">Block User</a>
										<?php } else { ?>
																				<a class="btn btn-info btn-block" href="Apk/UnblockUser?Uid=<?php echo $row['member_user_id']; ?>" style="padding-top:10px">Unblock User</a>
										<?php } ?>
									</div>
								</div>
