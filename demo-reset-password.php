...
<head>
    ...
    <?php
          include "components/cssComponents/demo2-css.php";
          ?>
...
<body>
    <main class="hp-bg-color-dark-90 d-flex min-vh-100">
        ...
        <?php
        $title1="Account Type";
        $title2="Demo Account Reset password";  
            ...
            <div class="row mb-32 gy-32">
                            ...
                            <div class="card-body">
                                ...
                                <form>
                                    <div class="mb-24 mt-15">
                                        <label for="mt5group" class="form-label">MT5 DEMO ACCOUNT</label>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="card hp-card-5" style="margin-top: 14px;">
                            <div class="card-body">
                                <h5 class="mb-32">How To Demo Account Reset Password</h5>

                                <ul class="timeline hp-p2-body">
                                    <li class="timeline-item">
                                        <div class="timeline-item-tail"></div>
                                        <div class="timeline-item-head"></div>
                                        <div class="timeline-item-content">Select mt5 Demo Account Dropdown</div>
                                    </li>
                                    <li class="timeline-item">
                                        <div class="timeline-item-tail"></div>
                                        <div class="timeline-item-head"></div>
  ...
  ?>
    ...
    <?php
  include "components/jsComponents/demo2-js.php";
  ?>
