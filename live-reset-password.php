...
<head>
    ...
    <?php
      include "components/cssComponents/live2-css.php";
      ?>
...
<body>
            ...
            <div class="row mb-32 gy-32">
                    ...
                    <div class="col-12 col-md-8">
                        <div class="card custom-card">
                            <div class="card-body">
                                <h3 class="card-title mb-32">Account Reset Password</h3>
                                <form>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="card hp-card-5" style="margin-top: 14px;">
                            <div class="card-body">
                                <h5 class="mb-32">How To Live Account Reset Password</h5>

                                <ul class="timeline hp-p2-body">
                                    <li class="timeline-item">
                                        <div class="timeline-item-tail"></div>
                                        <div class="timeline-item-head"></div>
                                        <div class="timeline-item-content">Select mt5 Live Account Dropdown</div>
                                    </li>
                                    <li class="timeline-item">
                                        <div class="timeline-item-tail"></div>
                                        <div class="timeline-item-head"></div>
                                        <div class="timeline-item-content">Enter New Password In Textbox</div>
                                    </li>
                                    <li class="timeline-item">
                                        <div class="timeline-item-tail"></div>
                                        <div class="timeline-item-head"></div>
                                        <div class="timeline-item-content">Click On Reset Password Button</div>
                                    </li>
                                    <li class="timeline-item">
                                        <div class="timeline-item-tail"></div>
                                        <div class="timeline-item-head"></div>
    ...
    <?php
      include "components/jsComponents/live2-js.php";
      ?>
</body>
