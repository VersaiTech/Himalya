                                ...
                                <div class="category-sub-menu card-number-show">
                                    ...
                                    <div class="sub-total-cart-balance">
                                        <div class="bottom-content-deals mt--10">
                                            ...
                                            <p>Earn Unlimited by Referral our Product. Share your Experience</span></p>
                                        </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="feature-product-area-single bg_image">
                    ...
                    <div class="inner-content" style="text-align: center;">
                        ...
                        <a href="http://localhost/Himallya-MLM/overview" class="affiliate-login-btn" style="display: inline-block; margin-top: 15px; text-align: center; background-color: #007bff; color: #fff; padding: 8px 20px; border-radius: 5px; font-size: 14px;">
                            Login
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                ...
                <div class="feature-product-area-single two bg_image">
                    ...
                    <div class="inner-content" style="text-align: center;">
                        ...
                        <a href="checkout.html" class="join-affiliate-btn" style="display: inline-block; margin-top: 15px; text-align: center; background-color: #28a745; color: #fff; padding: 8px 20px; border-radius: 5px; font-size: 14px;">
                            Join Now
                        </a>
                    </div>
                </div>
