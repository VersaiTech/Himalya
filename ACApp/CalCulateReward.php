...
<head>
	...
	<title>Calculate Reward | Admin Panel</title>
		...
		<div class="page-wrapper">
			<div class="content container-fluid">
				...
				<div class="page-header">
					<div class="row">
						<div class="col">
							<h5 class="page-title">Calculate Reward</h5>
						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-header">
									<h6 class="card-title">Calculate Reward</h6>
								</div>
								<div class="card-body">
							...
							<div class="row filter-row">
								<div class="col-sm-6 col-md-3">
									<div class="form-group">
										<label>Last Reward Payment</label>
										<input class="form-control" type="text" name="lastPaymentDate" id="lastPaymentDate" value="<?php echo date("d-M-Y",strtotime($lastreward_paid)); ?>" readonly style="background-color:#fff">
									</div>
								</div>
								<div class="col-sm-6 col-md-3">
									<div class="form-group">
